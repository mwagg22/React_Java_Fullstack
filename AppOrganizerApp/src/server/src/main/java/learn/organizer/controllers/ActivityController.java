...
public class ActivityController {
    ...
    public ResponseEntity<Object> deleteById(@PathVariable int activityId) {
    ...
    public ResponseEntity<Object> deleteUserFromActivity(@PathVariable int userId,@PathVariable int activityId) {
    ...
    public ResponseEntity<Object> deleteAllUserActivity(@PathVariable int userId) {
