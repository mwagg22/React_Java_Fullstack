...
export default function Participants(props){
    ...
    const getParticipants = () => {
        ...
        fetch('http://groopbackend.us-east-1.elasticbeanstalk.com/api/activity/participants/' + props.activityId, init)
    ...
    const checkInParticipant = (userId)=>{
     const init = {
        ...
        fetch('http://groopbackend.us-east-1.elasticbeanstalk.com/api/activity/participants/' + props.activityId+"/"+userId, init)
            .then(response => response.json())
            .then(data => { setParticipants(data);console.log(data); })
            .catch(error => console.log(error));
