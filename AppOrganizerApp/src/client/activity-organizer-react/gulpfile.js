...
const paths = {
  ...
  app_src: '../prod-build/app',
  server_file_name: 'server.bundle.js',
  react_src: '../activity-organizer-react/build/**/*',
  react_dist: '../prod-build/activity-organizer-react/build',
...
function buildReactCodeTask(cb) {
  ...
  return exec('cd ../activity-organizer-react && npm run build', function (err, stdout, stderr) {
    log(stdout);
    log(stderr);
    cb(err);
  })
